...
const NirvaContext = createContext({ apiKey: null });

export const NirvaProvider = ({ children }) => {
    // Read from environment (Vite or Node)
    const apiKey =
        import.meta.env.NV_SECRET_KEY ||
    ...
    return (
        <NirvaContext.Provider value={{ apiKey }}>
            {children}
        </NirvaContext.Provider>
    );
};
