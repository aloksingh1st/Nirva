...
var init_tokenService = __esm({
  "src/services/tokenService.ts"() {
    ...
    generateToken = (user) => {
      ...
      return jwt2.sign(payload, process.env.JWT_SECRET, {
        expiresIn: "7d"
      });
    };
  }
...
var findOrCreateUser, register, login;
...
var require_google = __commonJS({
  "src/strategies/google.ts"(exports) {
    "use strict";
    init_userService();
...
var require_github = __commonJS({
  "src/strategies/github.ts"(exports) {
    "use strict";
    init_db();
    init_tokenService();
    passport3.use(
