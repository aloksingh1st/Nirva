...
var init_tokenService = __esm({
  "src/services/tokenService.ts"() {
    ...
    generateToken = (user) => {
      ...
      return import_jsonwebtoken2.default.sign(payload, process.env.JWT_SECRET, {
        expiresIn: "7d"
      });
    };
  }
...
var require_library = __commonJS({
  "src/generated/prisma/runtime/library.js"(exports2, module2) {
    ...
    var Ai = ne((bh, ws) => {
      "use strict";
      ws.exports = (e, r = 1, t) => {
        if (t = __spreadValues({ indent: " ", includeEmptyLines: false }, t), typeof e != "string") throw new TypeError(`Expected \`input\` to be a \`string\`, got \`${typeof e}\``);
...
`), o = o.replace(/\\r/g, "\r")), r[i] = o;
    ...
    var _a2, _b;
    (_b = globalThis.DEBUG) != null ? _b : globalThis.DEBUG = (_a2 = oi.DEBUG) != null ? _a2 : "";
    var _a3;
    (_a3 = globalThis.DEBUG_COLORS) != null ? _a3 : globalThis.DEBUG_COLORS = oi.DEBUG_COLORS ? oi.DEBUG_COLORS === "true" : true;
    var Yr = { enable(e) {
      ...
      var _a21;
      let [r, t, ...n] = e;
      ((_a21 = console.warn) != null ? _a21 : console.log)(`${r} ${t}`, ...n);
    }, formatters: {} };
    function Gu(e) {
...
`);
    ...
    function Zo() {
      return __async(this, null, function* () {
        ...
        if (e === "freebsd") {
          let s = yield Yt("freebsd-version");
        ...
        let t = yield ec(), n = yield lc(), i = tc({ arch: r, archFromUname: n, familyDistro: t.familyDistro }), { libssl: o } = yield nc(i);
...
${JSON.stringify(a, null, 2)}`), a;
    ...
    function ec() {
      return __async(this, null, function* () {
        ...
        try {
          let r = yield di.default.readFile(e, { encoding: "utf-8" });
          return Xu(r);
        } catch (e2) {
    ...
    function Ho(e) {
      ...
      if (r) {
        let t = `${r[1]}${(_a21 = r[2]) != null ? _a21 : ".0"}.x`;
        return Xo(t);
      }
    }
    function Xo(e) {
    ...
    function nc(e) {
      return __async(this, null, function* () {
        let r = 'grep -v "libssl.so.0"', t = yield Ko(e);
        if (t) {
        ...
        let n = yield Yt(`ldconfig -p | sed "s/.*=>s*//" | sed "s|.*/||" | grep libssl | sort | ${r}`);
        if (n || (n = yield Ko(["/lib64", "/usr/lib64", "/lib", "/usr/lib"])), n) {
          ee(`Found libssl.so file using "ldconfig" or other generic paths: ${n}`);
          let o = Ho(n);
          if (ee(`The parsed libssl version is: ${o}`), o) return { libssl: o, strategy: "ldconfig" };
        }
        let i = yield Yt("openssl version -v");
        if (i) {
    ...
    function ic(e) {
      return __async(this, null, function* () {
        try {
          return (yield di.default.readdir(e)).find((t) => t.startsWith("libssl.so.") && !t.startsWith("libssl.so.0"));
        } catch (r) {
    ...
    function mi() {
      return __async(this, null, function* () {
        let _a21 = yield es(), { memoized: e } = _a21, r = __objRest(_a21, ["memoized"]);
        return r;
      });
    }
    var Ht = {};
    function es() {
      return __async(this, null, function* () {
        if (oc(Ht)) return Promise.resolve(__spreadProps(__spreadValues({}, Ht), { memoized: true }));
        let e = yield Zo(), r = sc(e);
        return Ht = __spreadProps(__spreadValues({}, e), { binaryTarget: r }), __spreadProps(__spreadValues({}, Ht), { memoized: false });
      });
    }
    function sc(e) {
...
${c}`);
    ...
    function Yt(e) {
      return ac(() => __async(null, null, function* () {
        let r = yield zu(e);
    ...
    function lc() {
      return __async(this, null, function* () {
        var _a21;
        return typeof Kt.default.machine == "function" ? Kt.default.machine() : (_a21 = yield Yt("uname -m")) == null ? void 0 : _a21.trim();
      });
    }
    function rs(e) {
    ...
    var _a4;
    var zt = ((_a4 = globalThis.window) == null ? void 0 : _a4.document) !== void 0;
    var _a5, _b2;
    var hg = ((_b2 = (_a5 = globalThis.process) == null ? void 0 : _a5.versions) == null ? void 0 : _b2.node) !== void 0;
    var _a6, _b3;
    var yg = ((_b3 = (_a6 = globalThis.process) == null ? void 0 : _a6.versions) == null ? void 0 : _b3.bun) !== void 0;
    var _a7, _b4;
    var Eg = ((_b4 = (_a7 = globalThis.Deno) == null ? void 0 : _a7.version) == null ? void 0 : _b4.deno) !== void 0;
    var _a8, _b5;
    var bg = ((_b5 = (_a8 = globalThis.process) == null ? void 0 : _a8.versions) == null ? void 0 : _b5.electron) !== void 0;
    var _a9, _b6;
    var wg = ((_b6 = (_a9 = globalThis.navigator) == null ? void 0 : _a9.userAgent) == null ? void 0 : _b6.includes("jsdom")) === true;
    ...
    var _a10, _b7;
    var Zr = (_b7 = (_a10 = globalThis.navigator) == null ? void 0 : _a10.userAgentData) == null ? void 0 : _b7.platform;
    var _a11, _b8, _c2, _d2;
    var Sg = Zr === "macOS" || ((_a11 = globalThis.navigator) == null ? void 0 : _a11.platform) === "MacIntel" || ((_c2 = (_b8 = globalThis.navigator) == null ? void 0 : _b8.userAgent) == null ? void 0 : _c2.includes(" Mac ")) === true || ((_d2 = globalThis.process) == null ? void 0 : _d2.platform) === "darwin";
    var _a12, _b9;
    var Rg = Zr === "Windows" || ((_a12 = globalThis.navigator) == null ? void 0 : _a12.platform) === "Win32" || ((_b9 = globalThis.process) == null ? void 0 : _b9.platform) === "win32";
    var _a13, _b10, _c3, _d3, _e2;
    var Cg = Zr === "Linux" || ((_b10 = (_a13 = globalThis.navigator) == null ? void 0 : _a13.platform) == null ? void 0 : _b10.startsWith("Linux")) === true || ((_d3 = (_c3 = globalThis.navigator) == null ? void 0 : _c3.userAgent) == null ? void 0 : _d3.includes(" Linux ")) === true || ((_e2 = globalThis.process) == null ? void 0 : _e2.platform) === "linux";
    var _a14, _b11, _c4;
    var Ag = Zr === "iOS" || ((_a14 = globalThis.navigator) == null ? void 0 : _a14.platform) === "MacIntel" && ((_b11 = globalThis.navigator) == null ? void 0 : _b11.maxTouchPoints) > 1 || /iPad|iPhone|iPod/.test((_c4 = globalThis.navigator) == null ? void 0 : _c4.platform);
    var _a15, _b12, _c5, _d4;
    var Ig = Zr === "Android" || ((_a15 = globalThis.navigator) == null ? void 0 : _a15.platform) === "Android" || ((_c5 = (_b12 = globalThis.navigator) == null ? void 0 : _b12.userAgent) == null ? void 0 : _c5.includes(" Android ")) === true || ((_d4 = globalThis.process) == null ? void 0 : _d4.platform) === "android";
    var I = "\x1B[";
    var et = "\x1B]";
    var yr = "\x07";
    var Xr = ";";
    ...
    var en = k(ds(), 1);
    function or(e, r, _a21 = {}) {
      var _b13 = _a21, { target: t = "stdout" } = _b13, n = __objRest(_b13, ["target"]);
    ...
    or.stderr = (e, r, t = {}) => or(e, r, __spreadValues({ target: "stderr" }, t));
...
Details: ${r.message}`;
    ...
    function nn(e) {
      var _a21;
      return (_a21 = e == null ? void 0 : e.toString().startsWith(`${tn}//`)) != null ? _a21 : false;
    }
    function Ci(e) {
...
`);
    ...
    function Os(e) {
      let r = e.ignoreProcessEnv ? {} : process.env, t = (n) => {
        var _a21, _b13;
        return (_b13 = (_a21 = n.match(/(.?\${(?:[a-zA-Z0-9_]+)?})/g)) == null ? void 0 : _a21.reduce(function(o, s) {
...
`), parsed: __spreadValues(__spreadValues({}, (_a21 = n == null ? void 0 : n.dotenvResult) == null ? void 0 : _a21.parsed), (_b13 = i == null ? void 0 : i.dotenvResult) == null ? void 0 : _b13.parsed) };
    }
    function hp(e, r, t) {
...
Env vars from ${Y(l)} overwrite the ones from ${Y(a)}
    ...
    var Pe = class {
      ...
      get(r) {
        var _a21;
        return (_a21 = this._map.get(r)) == null ? void 0 : _a21.value;
      }
      set(r, t) {
    ...
    function Qi(e) {
      let r = {};
      for (let _a21 of e) {
        let _b13 = _a21, { name: t } = _b13, n = __objRest(_b13, ["name"]);
        r[t] = n;
      }
      return r;
    }
...
`);
    ...
    function xd({ callsite: e, message: r, originalMethod: t, isPanic: n, callArguments: i }, o) {
      ...
      let l = Math.max(1, a.lineNumber - 3), u = (_a21 = bn.read(a.fileName)) == null ? void 0 : _a21.slice(l, a.lineNumber), c = u == null ? void 0 : u.lineAt(a.lineNumber);
      if (u && c) {
        let p = Pd(c), d = vd(c);
        if (!d) return s;
...
`);
    ...
    function Rd(e) {
      ...
      for (let n of e) {
        ...
        o ? r.set(i, __spreadProps(__spreadValues({}, n), { argument: __spreadProps(__spreadValues({}, n.argument), { typeNames: Cd(o.argument.typeNames, n.argument.typeNames) }) })) : r.set(i, n);
      }
...
`);
    ...
    var Dr = class e extends ze {
      ...
      getDeepFieldValue(r) {
        var _a21;
        return r.length === 0 ? this : (_a21 = this.getDeepField(r)) == null ? void 0 : _a21.value;
      }
      hasField(r) {
      ...
      getFieldValue(r) {
        var _a21;
        return (_a21 = this.getField(r)) == null ? void 0 : _a21.value;
      }
      ...
      getSelectionParent() {
        var _a21, _b13;
        let r = (_a21 = this.getField("select")) == null ? void 0 : _a21.value.asObject();
        if (r) return { kind: "select", value: r };
        let t = (_b13 = this.getField("include")) == null ? void 0 : _b13.value.asObject();
        if (t) return { kind: "include", value: t };
      }
      getSubSelectionValue(r) {
        var _a21;
        return (_a21 = this.getSelectionParent()) == null ? void 0 : _a21.value.fields[r].value;
      }
      getPrintWidth() {
    ...
    function Id(e, r) {
      var _a21, _b13, _c6;
      let t = (_a21 = r.arguments.getDeepSubSelectionValue(e.selectionPath)) == null ? void 0 : _a21.asObject();
      t && ((_b13 = t.getField(e.firstField)) == null ? void 0 : _b13.markAsError(), (_c6 = t.getField(e.secondField)) == null ? void 0 : _c6.markAsError()), r.addErrorMessage((n) => `Please ${n.bold("either")} use ${n.green(`\`${e.firstField}\``)} or ${n.green(`\`${e.secondField}\``)}, but ${n.red("not both")} at the same time.`);
    }
    function kd(e, r) {
      var _a21, _b13;
      let [t, n] = pt(e.selectionPath), i = e.outputType, o = (_a21 = r.arguments.getDeepSelectionParent(t)) == null ? void 0 : _a21.value;
      if (o && ((_b13 = o.getField(n)) == null ? void 0 : _b13.markAsError(), i)) for (let s of i.fields) s.isRelation && o.addSuggestion(new ue(s.name, "true"));
      r.addErrorMessage((s) => {
...
Note that ${s.bold("include")} statements only accept relation fields.`, a;
    ...
    function Dd(e, r, t) {
      var _a21, _b13;
      let n = (_a21 = r.arguments.getDeepSubSelectionValue(e.selectionPath)) == null ? void 0 : _a21.asObject();
      if (n) {
        let i = (_b13 = n.getField("omit")) == null ? void 0 : _b13.value.asObject();
        if (i) {
          Od(e, r, i);
          return;
        }
    ...
    function _d(e, r) {
      var _a21, _b13;
      let t = e.outputType, n = (_a21 = r.arguments.getDeepSelectionParent(e.selectionPath)) == null ? void 0 : _a21.value, i = (_b13 = n == null ? void 0 : n.isEmpty()) != null ? _b13 : false;
    ...
    function Nd(e, r) {
      ...
      if (e.selectionPath.length === 0) r.arguments.addSuggestion(n);
        ...
        let [i, o] = pt(e.selectionPath), a = (_b13 = (_a21 = r.arguments.getDeepSelectionParent(i)) == null ? void 0 : _a21.value.asObject()) == null ? void 0 : _b13.getField(o);
        if (a) {
          let l = (_c6 = a == null ? void 0 : a.value.asObject()) != null ? _c6 : new Dr();
    ...
    function Md(e, r) {
      var _a21, _b13;
      let t = e.argumentPath[0], n = (_a21 = r.arguments.getDeepSubSelectionValue(e.selectionPath)) == null ? void 0 : _a21.asObject();
      n && ((_b13 = n.getField(t)) == null ? void 0 : _b13.markAsError(), Jd(n, e.arguments)), r.addErrorMessage((i) => ma(i, t, e.arguments.map((o) => o.name)));
    }
    function $d(e, r) {
      var _a21, _b13, _c6;
      let [t, n] = pt(e.argumentPath), i = (_a21 = r.arguments.getDeepSubSelectionValue(e.selectionPath)) == null ? void 0 : _a21.asObject();
      if (i) {
        (_b13 = i.getDeepField(e.argumentPath)) == null ? void 0 : _b13.markAsError();
    ...
    function qd(e, r) {
      ...
      let n = (_a21 = r.arguments.getDeepSubSelectionValue(e.selectionPath)) == null ? void 0 : _a21.asObject();
      if (!n) return;
      let [i, o] = pt(e.argumentPath), s = new ct(), a = (_b13 = n.getDeepFieldValue(i)) == null ? void 0 : _b13.asObject();
    ...
    function jd(e, r) {
      var _a21, _b13;
      let t = e.argument.name, n = (_a21 = r.arguments.getDeepSubSelectionValue(e.selectionPath)) == null ? void 0 : _a21.asObject();
      n && ((_b13 = n.getDeepFieldValue(e.argumentPath)) == null ? void 0 : _b13.markAsError()), r.addErrorMessage((i) => {
    ...
    function Bd(e, r) {
      var _a21, _b13;
      let t = e.argument.name, n = (_a21 = r.arguments.getDeepSubSelectionValue(e.selectionPath)) == null ? void 0 : _a21.asObject(), i;
      if (n) {
        let s = (_b13 = n.getDeepField(e.argumentPath)) == null ? void 0 : _b13.value;
    ...
    function Ud(e, r) {
      var _a21, _b13;
      let t = e.argumentPath[e.argumentPath.length - 1], n = (_a21 = r.arguments.getDeepSubSelectionValue(e.selectionPath)) == null ? void 0 : _a21.asObject();
      if (n) {
        let i = (_b13 = n.getDeepFieldValue(e.argumentPath)) == null ? void 0 : _b13.asObject();
        i && ya(i, e.inputType);
      }
      r.addErrorMessage((i) => {
    ...
    function Gd(e, r) {
      var _a21, _b13;
      let t = e.argumentPath[e.argumentPath.length - 1], n = (_a21 = r.arguments.getDeepSubSelectionValue(e.selectionPath)) == null ? void 0 : _a21.asObject(), i = [];
      if (n) {
        let o = (_b13 = n.getDeepFieldValue(e.argumentPath)) == null ? void 0 : _b13.asObject();
    ...
    function ha(e, r) {
      var _a21, _b13, _c6, _d5;
      let [t, n] = pt(e), i = (_a21 = r.arguments.getDeepSubSelectionValue(t)) == null ? void 0 : _a21.asObject();
      if (!i) return { parentKind: "unknown", fieldName: n };
      let o = (_b13 = i.getFieldValue("select")) == null ? void 0 : _b13.asObject(), s = (_c6 = i.getFieldValue("include")) == null ? void 0 : _c6.asObject(), a = (_d5 = i.getFieldValue("omit")) == null ? void 0 : _d5.asObject(), l = o == null ? void 0 : o.getField(n);
    ...
    var _e3, _a16;
    var gt = (_a16 = class extends ft {
      constructor() {
        super(...arguments);
        __privateAdd(this, _e3);
      }
    }, _e3 = new WeakMap(), _a16);
    Ki(gt, "DbNull");
    var _e4, _a17;
    var ht = (_a17 = class extends ft {
      constructor() {
        super(...arguments);
        __privateAdd(this, _e4);
      }
    }, _e4 = new WeakMap(), _a17);
    Ki(ht, "JsonNull");
    var _e5, _a18;
    var yt = (_a18 = class extends ft {
      constructor() {
        super(...arguments);
        __privateAdd(this, _e5);
      }
    }, _e5 = new WeakMap(), _a18);
    Ki(yt, "AnyNull");
...
`);
    ...
    function va(e, r, t) {
      let n = Se(t);
      return !r.result || !(r.result.$allModels || r.result[n]) ? e : zd(__spreadValues(__spreadValues(__spreadValues({}, e), xa(r.name, e, r.result.$allModels)), xa(r.name, e, r.result[n])));
    }
    function zd(e) {
      let r = new Pe(), t = (n, i) => r.getOrCreate(n, () => i.has(n) ? [n] : (i.add(n), e[n] ? e[n].needs.flatMap((o) => t(o, i)) : [n]));
      return xr(e, (n) => __spreadProps(__spreadValues({}, n), { needs: t(n.name, /* @__PURE__ */ new Set()) }));
    }
    function xa(e, r, t) {
    ...
    function Zd(e, r, t) {
      var _a21;
      let n = (_a21 = e == null ? void 0 : e[r]) == null ? void 0 : _a21.compute;
    ...
    var Dn = class {
      constructor(r, t) {
        ...
        __publicField(this, "clientExtensions", lt(() => {
          var _a21, _b13;
          return this.extension.client ? __spreadValues(__spreadValues({}, (_a21 = this.previous) == null ? void 0 : _a21.getAllClientExtensions()), this.extension.client) : (_b13 = this.previous) == null ? void 0 : _b13.getAllClientExtensions();
        }));
        __publicField(this, "batchCallbacks", lt(() => {
          var _a21, _b13, _c6;
          let r = (_b13 = (_a21 = this.previous) == null ? void 0 : _a21.getAllBatchQueryCallbacks()) != null ? _b13 : [], t = (_c6 = this.extension.query) == null ? void 0 : _c6.$__internalBatch;
      ...
      getAllComputedFields(r) {
        return this.computedFieldsCache.getOrCreate(r, () => {
          var _a21;
          return va((_a21 = this.previous) == null ? void 0 : _a21.getAllComputedFields(r), this.extension, r);
        });
      }
      ...
      getAllModelExtensions(r) {
        return this.modelExtensionsCache.getOrCreate(r, () => {
          var _a21, _b13;
          let t = Se(r);
          return !this.extension.model || !(this.extension.model[t] || this.extension.model.$allModels) ? (_a21 = this.previous) == null ? void 0 : _a21.getAllModelExtensions(r) : __spreadValues(__spreadValues(__spreadValues({}, (_b13 = this.previous) == null ? void 0 : _b13.getAllModelExtensions(r)), this.extension.model.$allModels), this.extension.model[t]);
        });
      }
      getAllQueryCallbacks(r, t) {
        return this.queryCallbacksCache.getOrCreate(`${r}:${t}`, () => {
          var _a21, _b13;
          let n = (_b13 = (_a21 = this.previous) == null ? void 0 : _a21.getAllQueryCallbacks(r, t)) != null ? _b13 : [], i = [], o = this.extension.query;
    ...
    var Nr = class e {
      ...
      getAllComputedFields(r) {
        var _a21;
        return (_a21 = this.head) == null ? void 0 : _a21.getAllComputedFields(r);
      }
      getAllClientExtensions() {
        var _a21;
        return (_a21 = this.head) == null ? void 0 : _a21.getAllClientExtensions();
      }
      getAllModelExtensions(r) {
        var _a21;
        return (_a21 = this.head) == null ? void 0 : _a21.getAllModelExtensions(r);
      }
      getAllQueryCallbacks(r, t) {
        var _a21, _b13;
        return (_b13 = (_a21 = this.head) == null ? void 0 : _a21.getAllQueryCallbacks(r, t)) != null ? _b13 : [];
      }
      getAllBatchQueryCallbacks() {
        var _a21, _b13;
        return (_b13 = (_a21 = this.head) == null ? void 0 : _a21.getAllBatchQueryCallbacks()) != null ? _b13 : [];
      }
    };
    var On = class {
      constructor(r) {
    ...
    function bt(_a21 = {}, n) {
      var _b13 = _a21, { select: e, include: r } = _b13, t = __objRest(_b13, ["select", "include"]);
      let i = t.omit;
    ...
    function nm(e, r, t) {
      let n = t.getComputedFields(), i = __spreadValues(__spreadValues({}, t.getGlobalOmit()), r), o = Ta(i, n);
    ...
    var zi = class e {
      constructor(r) {
        ...
        var _a21;
        this.params = r;
        this.params.modelName && (this.modelOrType = (_a21 = this.params.runtimeDataModel.models[this.params.modelName]) != null ? _a21 : this.params.runtimeDataModel.types[this.params.modelName]);
      }
      throwValidationError(r) {
        var _a21;
        kn({ errors: [r], originalMethod: this.params.originalMethod, args: (_a21 = this.params.rootArgs) != null ? _a21 : {}, callsite: this.params.callsite, errorFormat: this.params.errorFormat, clientVersion: this.params.clientVersion, globalOmit: this.params.globalOmit });
      }
      getSelectionPath() {
      ...
      findField(r) {
        var _a21;
        return (_a21 = this.modelOrType) == null ? void 0 : _a21.fields.find((t) => t.name === r);
      }
      nestSelection(r) {
      ...
      getGlobalOmit() {
        var _a21, _b13;
        return this.params.modelName && this.shouldApplyGlobalOmit() ? (_b13 = (_a21 = this.params.globalOmit) == null ? void 0 : _a21[Ye(this.params.modelName)]) != null ? _b13 : {} : {};
      }
    ...
    var Lr = class {
      ...
      prometheus(r) {
        return Da(this._client), this._client._engine.metrics(__spreadValues({ format: "prometheus" }, r));
      }
      json(r) {
        return Da(this._client), this._client._engine.metrics(__spreadValues({ format: "json" }, r));
      }
    };
    function Oa(e, r) {
      let t = lt(() => lm(r));
    ...
    function ar(e) {
      ...
      return { getKeys() {
        ...
        var _a21;
        return (_a21 = e.getPropertyDescriptor) == null ? void 0 : _a21.call(e, t);
      } };
    }
    ...
    function he(e, r) {
      let t = um(r), n = /* @__PURE__ */ new Set(), i = new Proxy(e, { get(o, s) {
        ...
        let a = t.get(s);
        return a ? (_b13 = (_a21 = a.has) == null ? void 0 : _a21.call(a, s)) != null ? _b13 : true : Reflect.has(o, s);
      }, ownKeys(o) {
        let s = Ma(Reflect.ownKeys(o), t), a = Ma(Array.from(t.keys()), t);
        return [.../* @__PURE__ */ new Set([...s, ...a, ...n])];
      }, set(o, s, a) {
        var _a21, _b13, _c6;
        return ((_c6 = (_b13 = (_a21 = t.get(s)) == null ? void 0 : _a21.getPropertyDescriptor) == null ? void 0 : _b13.call(_a21, s)) == null ? void 0 : _c6.writable) === false ? false : (n.add(s), Reflect.set(o, s, a));
      }, getOwnPropertyDescriptor(o, s) {
        let a = Reflect.getOwnPropertyDescriptor(o, s);
        if (a && !a.configurable) return a;
        let l = t.get(s);
        return l ? l.getPropertyDescriptor ? __spreadValues(__spreadValues({}, Mn), l == null ? void 0 : l.getPropertyDescriptor(s)) : Mn : a;
    ...
    function Ma(e, r) {
      return e.filter((t) => {
        var _a21, _b13, _c6;
        return (_c6 = (_b13 = (_a21 = r.get(t)) == null ? void 0 : _a21.has) == null ? void 0 : _b13.call(_a21, t)) != null ? _c6 : true;
      });
    }
    function Fr(e) {
      return { getKeys() {
...
`);
    ...
    function Rm(e = {}) {
      let _a21 = e, { select: r } = _a21, t = __objRest(_a21, ["select"]);
      return typeof r == "object" ? qr(__spreadProps(__spreadValues({}, t), { _count: r })) : qr(__spreadProps(__spreadValues({}, t), { _count: { _all: true } }));
    }
    function Cm(e = {}) {
    ...
    function Dm(e, r, t) {
      return r === void 0 ? e != null ? e : {} : Ja(r, t, e || true);
    }
    function so(e, r, t, n, i, o) {
      ...
      return (l) => {
        ...
        return new Proxy(d, __spreadValues({ get(h, g) {
    ...
    function ao(e, r) {
      var _a21;
      let t = (_a21 = e._extensions.getAllModelExtensions(r)) != null ? _a21 : {}, n = [Lm(e, r), Mm(e, r), xt(t), re("name", () => r), re("$name", () => r), re("$parent", () => e._appliedParent)];
      return he({}, n);
    }
    function Lm(e, r) {
      ...
      return { getKeys() {
        ...
        let o = i, s = (a) => (l) => {
          ...
          return e._createPrismaPromise((c) => {
            ...
            return e._request(__spreadValues(__spreadValues({}, p), a));
    ...
    function Ya(e) {
      ...
      if ((_a21 = e.client) == null ? void 0 : _a21.__AccelerateEngine) {
    ...
    function jn({ visitor: e, result: r, args: t, runtimeDataModel: n, modelName: i }) {
      ...
      let o = (_a21 = e(r, i, t)) != null ? _a21 : r;
    ...
    function Xa({ result: e, modelName: r, args: t, extensions: n, runtimeDataModel: i, globalOmit: o }) {
      return n.isEmpty() || e == null || typeof e != "object" || !i.models[r] ? e : jn({ result: e, args: t != null ? t : {}, modelName: r, runtimeDataModel: i, visitor: (a, l, u) => {
        let c = Se(l);
        return za({ result: a, modelName: c, select: u.select, omit: u.select ? void 0 : __spreadValues(__spreadValues({}, o == null ? void 0 : o[c]), u.omit), extensions: n });
      } });
    }
    ...
    function nl(e, r, t, n = 0) {
      return e._createPrismaPromise((i) => {
        ...
        return "transaction" in r && i !== void 0 && (((_a21 = r.transaction) == null ? void 0 : _a21.kind) === "batch" && r.transaction.lock.then(), r.transaction = i), n === t.length ? e._executeRequest(r) : t[n]({ model: r.model, operation: r.model ? r.action : r.clientMethod, args: rl((_b13 = r.args) != null ? _b13 : {}), __internalParams: r, query: (s, a = r) => {
...
Learn how: https://pris.ly/d/${ul[r]}-build`;
    ...
    var Qm = () => {
      var _a21, _b13;
      return ((_b13 = (_a21 = globalThis.process) == null ? void 0 : _a21.release) == null ? void 0 : _b13.name) === "node";
    };
    var Wm = () => {
      var _a21, _b13;
      return !!globalThis.Bun || !!((_b13 = (_a21 = globalThis.process) == null ? void 0 : _a21.versions) == null ? void 0 : _b13.bun);
    };
    ...
    var Ym = () => {
      var _a21;
      return ((_a21 = globalThis.navigator) == null ? void 0 : _a21.userAgent) === "Cloudflare-Workers";
    };
    function zm() {
      var _a21;
      return (_a21 = [[Hm, "netlify"], [Km, "edge-light"], [Ym, "workerd"], [Jm, "deno"], [Wm, "bun"], [Qm, "node"]].flatMap((t) => t[0]() ? [t[1]] : []).at(0)) != null ? _a21 : "";
    }
...
${Xm(e)}`;
    ...
    function Xm(e) {
      ...
      return ki(__spreadProps(__spreadValues({}, r), { binaryTargets: o }));
    }
    function Xe(e) {
      let { runtimeBinaryTarget: r } = e;
...
This happened because Prisma Client was generated for "${(_a21 = n == null ? void 0 : n.value) != null ? _a21 : "unknown"}", but the actual deployment required "${r}".
${Bn(e)}
...
${er(e)}`;
    ...
    function yl(e, r) {
      return __async(this, null, function* () {
        var _a21, _b13, _c6;
        let t = (_a21 = { binary: process.env.PRISMA_QUERY_ENGINE_BINARY, library: process.env.PRISMA_QUERY_ENGINE_LIBRARY }[e]) != null ? _a21 : r.prismaPath;
        if (t !== void 0) return t;
        let { enginePath: n, searchedLocations: i } = yield tf(e, r);
        if (ef("enginePath", n), n !== void 0 && e === "binary" && Ti(n), n !== void 0) return r.prismaPath = n;
        let o = yield ir(), s = (_c6 = (_b13 = r.generator) == null ? void 0 : _b13.binaryTargets) != null ? _c6 : [], a = s.some((d) => d.native), l = !s.some((d) => d.value === o), u = __filename.match(rf()) === null, c = { searchedLocations: i, generatorBinaryTargets: s, generator: r.generator, runtimeBinaryTarget: o, queryEngineName: El(e, o), expectedLocation: St.default.relative(process.cwd(), r.dirname), errorStack: new Error().stack }, p;
    ...
    function tf(e, r) {
      return __async(this, null, function* () {
        var _a21, _b13, _c6;
        let t = yield ir(), n = [], i = [r.dirname, St.default.resolve(__dirname, ".."), (_c6 = (_b13 = (_a21 = r.generator) == null ? void 0 : _a21.output) == null ? void 0 : _b13.value) != null ? _c6 : __dirname, St.default.resolve(__dirname, "../../../.prisma/client"), "/tmp/prisma-engines", r.cwd];
...
`);
    ...
    function Pl({ version: e, binaryTarget: r, title: t, description: n, engineVersion: i, database: o, query: s }) {
      var _a21, _b13;
      let a = Go(6e3 - ((_a21 = s == null ? void 0 : s.length) != null ? _a21 : 0)), l = wl((0, uo.default)(a)), u = n ? `# Description
\`\`\`
${n}
...
| Name            | Version            |
|-----------------|--------------------|
| Node            | ${(_b13 = process.version) == null ? void 0 : _b13.padEnd(19)}| 
...
`;
    ...
    var Wn = (e, r = new po()) => {
      let t = { adapterName: e.adapterName, errorRegistry: r, queryRaw: Me(r, e.queryRaw.bind(e)), executeRaw: Me(r, e.executeRaw.bind(e)), executeScript: Me(r, e.executeScript.bind(e)), dispose: Me(r, e.dispose.bind(e)), provider: e.provider, startTransaction: (...n) => __async(null, null, function* () {
        return (yield Me(r, e.startTransaction.bind(e))(...n)).map((o) => nf(r, o));
      }) };
    ...
    function jr({ inlineDatasources: e, overrideDatasources: r, env: t, clientVersion: n }) {
      var _a21, _b13;
      let i, o = Object.keys(e)[0], s = (_a21 = e[o]) == null ? void 0 : _a21.url, a = (_b13 = r[o]) == null ? void 0 : _b13.url;
    ...
    var se = class extends Jn {
      constructor(r, t) {
        ...
        this.isRetryable = (_a21 = t.isRetryable) != null ? _a21 : true;
      }
    };
    function C(e, r) {
    ...
    function Ft(e, r) {
      return __async(this, null, function* () {
        if (e.ok) return;
        let t = { clientVersion: r, response: e }, n = yield uf(e);
    ...
    function Al(e) {
      var _a21;
      if (!!((_a21 = e.generator) == null ? void 0 : _a21.previewFeatures.some((t) => t.toLowerCase().includes("metrics")))) throw new T("The `metrics` preview feature is not yet available with Accelerate.\nPlease remove `metrics` from the `previewFeatures` in your schema.\n\nMore information about Accelerate: https://pris.ly/d/accelerate", e.clientVersion);
    }
    function cf(e) {
...
${r}`, C(t, true));
    ...
    x(Mt, "RequestError");
    function dr(e, r, t = (n) => n) {
      return __async(this, null, function* () {
        var _b13;
        let _a21 = r, { clientVersion: n } = _a21, i = __objRest(_a21, ["clientVersion"]), o = t(fetch);
        try {
          return yield o(e, i);
        } catch (s) {
          let a = (_b13 = s.message) != null ? _b13 : "Unknown error";
    ...
    function mf(e, r) {
      return __async(this, null, function* () {
        var _a21, _b13, _c6;
        let t = Il["@prisma/engines-version"], n = (_a21 = r.clientVersion) != null ? _a21 : "unknown";
        ...
        let [i, o] = (_b13 = n == null ? void 0 : n.split("-")) != null ? _b13 : [];
        if (o === void 0 && df.test(i)) return i;
        if (o !== void 0 || n === "0.0.0" || n === "in-memory") {
          let [s] = (_c6 = t.split("-")) != null ? _c6 : [], [a, l, u] = s.split("."), c = ff(`<=${a}.${l}.${u}`), p = yield dr(c, { clientVersion: n });
    ...
    var qt = class {
      constructor(r) {
        ...
        Al(r), this.config = r, this.env = __spreadValues(__spreadValues({}, r.env), typeof process < "u" ? process.env : {}), this.inlineSchema = Cl(r.inlineSchema), this.inlineDatasources = r.inlineDatasources, this.inlineSchemaHash = r.inlineSchemaHash, this.clientVersion = r.clientVersion, this.engineHash = r.engineVersion, this.logEmitter = r.logEmitter, this.tracingHelper = r.tracingHelper;
      }
      apiKey() {
      ...
      start() {
        return __async(this, null, function* () {
          this.startPromise !== void 0 && (yield this.startPromise), this.startPromise = (() => __async(this, null, function* () {
            ...
            this.host = t.host, this.headerBuilder = new wo({ apiKey: r, tracingHelper: this.tracingHelper, logLevel: this.config.logLevel, logQueries: this.config.logQueries, engineHash: this.engineHash }), this.protocol = Ci(t) ? "http" : "https", this.remoteClientVersion = yield Dl(this.host, this.config), $t("host", this.host), $t("protocol", this.protocol);
      ...
      propagateResponseExtensions(r) {
        var _a21, _b13;
        ((_a21 = r == null ? void 0 : r.logs) == null ? void 0 : _a21.length) && r.logs.forEach((t) => {
          var _a22, _b14, _c6, _d5;
          switch (t.level) {
            case "debug":
            case "trace":
              $t(t);
            ...
            case "warn":
            case "info": {
              this.logEmitter.emit(t.level, { timestamp: bo(t.timestamp), message: (_a22 = t.attributes.message) != null ? _a22 : "", target: t.target });
              break;
            }
            case "query": {
              this.logEmitter.emit("query", { query: (_b14 = t.attributes.query) != null ? _b14 : "", timestamp: bo(t.timestamp), duration: (_c6 = t.attributes.duration_ms) != null ? _c6 : 0, params: (_d5 = t.attributes.params) != null ? _d5 : "", target: t.target });
              break;
            }
            default:
              t.level;
          }
        }), ((_b13 = r == null ? void 0 : r.traces) == null ? void 0 : _b13.length) && this.tracingHelper.dispatchEngineSpans(r.traces);
      }
      onBeforeExit() {
      ...
      url(r) {
        return __async(this, null, function* () {
          return yield this.start(), `${this.protocol}://${this.host}/${this.remoteClientVersion}/${this.inlineSchemaHash}/${r}`;
        });
      }
      uploadSchema() {
        return __async(this, null, function* () {
          ...
          return this.tracingHelper.runInChildSpan(r, () => __async(this, null, function* () {
            let t = yield dr(yield this.url("schema"), { method: "PUT", headers: this.headerBuilder.build(), body: this.inlineSchema, clientVersion: this.clientVersion });
            t.ok || $t("schema response status", t.status);
            let n = yield Ft(t, this.clientVersion);
      ...
      requestBatch(_0, _1) {
        return __async(this, arguments, function* (r, { traceparent: t, transaction: n, customDataProxyFetch: i }) {
          ...
          return (yield this.requestInternal({ body: s, customDataProxyFetch: i, interactiveTransaction: o, traceparent: t })).map((l) => (l.extensions && this.propagateResponseExtensions(l.extensions), "errors" in l ? this.convertProtocolErrorsToClientError(l.errors) : l));
        });
      }
      requestInternal({ body: r, traceparent: t, customDataProxyFetch: n, interactiveTransaction: i }) {
        return this.withRetry({ actionGerund: "querying", callback: (_0) => __async(this, [_0], function* ({ logHttpCall: o }) {
          ...
          o(s);
          let a = yield dr(s, { method: "POST", headers: this.headerBuilder.build({ traceparent: t, interactiveTransaction: i }), body: JSON.stringify(r), clientVersion: this.clientVersion }, n);
          a.ok || $t("graphql response status", a.status), yield this.handleError(yield Ft(a, this.clientVersion));
          let l = yield a.json();
        ...
        return __async(this, null, function* () {
          ...
          return this.withRetry({ actionGerund: `${i[r]} transaction`, callback: (_0) => __async(this, [_0], function* ({ logHttpCall: o }) {
            if (r === "start") {
              ...
              o(a);
              let l = yield dr(a, { method: "POST", headers: this.headerBuilder.build({ traceparent: t.traceparent }), body: s, clientVersion: this.clientVersion });
              yield this.handleError(yield Ft(l, this.clientVersion));
              let u = yield l.json(), { extensions: c } = u;
              ...
              o(s);
              let a = yield dr(s, { method: "POST", headers: this.headerBuilder.build({ traceparent: t.traceparent }), clientVersion: this.clientVersion });
              yield this.handleError(yield Ft(a, this.clientVersion));
              let l = yield a.json(), { extensions: u } = l;
        ...
        return __async(this, null, function* () {
          ...
          for (let t = 0; ; t++) {
            ...
            try {
              ...
              this.logEmitter.emit("warn", { message: `Attempt ${t + 1}/${Ol} failed for ${r.actionGerund}: ${(_a21 = i.message) != null ? _a21 : "(unknown)"}`, timestamp: /* @__PURE__ */ new Date(), target: "" });
              let o = yield Rl(t);
      ...
      handleError(r) {
        return __async(this, null, function* () {
          if (r instanceof pr) throw yield this.uploadSchema(), new Vr({ clientVersion: this.clientVersion, cause: r });
          if (r) throw r;
        });
      }
    ...
    var Ll = { loadLibrary(e) {
      return __async(this, null, function* () {
        let r = yield mi(), t = yield yl("library", e);
        try {
    ...
    var Fl = { loadLibrary(e) {
      return __async(this, null, function* () {
        ...
        Po === void 0 && (Po = (() => __async(null, null, function* () {
          let o = yield n.getRuntime(), s = yield n.getQueryEngineWasmModule();
    ...
    var Ml = [...ai, "native"];
    var wf = /* @__PURE__ */ BigInt("0xffffffffffffffff");
    var To = /* @__PURE__ */ BigInt("1");
    function xf() {
      let e = To++;
      return To > wf && (To = /* @__PURE__ */ BigInt("1")), e;
    }
    var Gr = class {
      constructor(r, t) {
        ...
        var _a21, _b13, _c6;
        this.libraryLoader = t != null ? t : Ll, r.engineWasm !== void 0 && (this.libraryLoader = t != null ? t : Fl), this.config = r, this.libraryStarted = false, this.logQueries = (_a21 = r.logQueries) != null ? _a21 : false, this.logLevel = (_b13 = r.logLevel) != null ? _b13 : "error", this.logEmitter = r.logEmitter, this.datamodel = r.inlineSchema, this.tracingHelper = r.tracingHelper, r.enableDebugLogs && (this.logLevel = "debug");
        let n = Object.keys(r.overrideDatasources)[0], i = (_c6 = r.overrideDatasources[n]) == null ? void 0 : _c6.url;
        n !== void 0 && i !== void 0 && (this.datasourceOverrides = { [n]: i }), this.libraryInstantiationPromise = this.instantiateLibrary();
      }
      wrapEngine(r) {
        var _a21, _b13, _c6, _d5;
        return { applyPendingMigrations: (_a21 = r.applyPendingMigrations) == null ? void 0 : _a21.bind(r), commitTransaction: this.withRequestId(r.commitTransaction.bind(r)), connect: this.withRequestId(r.connect.bind(r)), disconnect: this.withRequestId(r.disconnect.bind(r)), metrics: (_b13 = r.metrics) == null ? void 0 : _b13.bind(r), query: this.withRequestId(r.query.bind(r)), rollbackTransaction: this.withRequestId(r.rollbackTransaction.bind(r)), sdlSchema: (_c6 = r.sdlSchema) == null ? void 0 : _c6.bind(r), startTransaction: this.withRequestId(r.startTransaction.bind(r)), trace: r.trace.bind(r), free: (_d5 = r.free) == null ? void 0 : _d5.bind(r) };
      }
      withRequestId(r) {
        return (...t) => __async(this, null, function* () {
          ...
          try {
            ...
            if (this.tracingHelper.isEnabled()) {
              let i = yield (_a21 = this.engine) == null ? void 0 : _a21.trace(n);
              if (i) {
                let o = JSON.parse(i);
      ...
      transaction(r, t, n) {
        return __async(this, null, function* () {
          var _a21, _b13, _c6;
          yield this.start();
          let i = yield this.adapterPromise, o = JSON.stringify(t), s;
          if (r === "start") {
            let l = JSON.stringify({ max_wait: n.maxWait, timeout: n.timeout, isolation_level: n.isolationLevel });
            s = yield (_a21 = this.engine) == null ? void 0 : _a21.startTransaction(l, o);
          } else r === "commit" ? s = yield (_b13 = this.engine) == null ? void 0 : _b13.commitTransaction(n.id, o) : r === "rollback" && (s = yield (_c6 = this.engine) == null ? void 0 : _c6.rollbackTransaction(n.id, o));
      ...
      instantiateLibrary() {
        return __async(this, null, function* () {
          ...
          si(), this.binaryTarget = yield this.getCurrentBinaryTarget(), yield this.tracingHelper.runInChildSpan("load_engine", () => this.loadEngine()), this.version();
        });
      }
        ...
        return __async(this, null, function* () {
          {
            ...
            let r = yield this.tracingHelper.runInChildSpan("detect_platform", () => ir());
...
You may have to run ${qe("prisma generate")} for your changes to take effect.`, this.config.clientVersion);
        ...
        return __async(this, null, function* () {
          ...
          if (!this.engine) {
            ...
            try {
              ...
              this.adapterPromise || (this.adapterPromise = (_b13 = (_a21 = this.config.adapter) == null ? void 0 : _a21.connect()) == null ? void 0 : _b13.then(Wn));
              let t = yield this.adapterPromise;
              t && Ce("Using driver adapter: %O", t), this.engine = this.wrapEngine(new this.QueryEngineConstructor({ datamodel: this.datamodel, env: process.env, logQueries: (_c6 = this.config.logQueries) != null ? _c6 : false, ignoreEnvVarErrors: true, datasourceOverrides: (_d5 = this.datasourceOverrides) != null ? _d5 : {}, logLevel: this.logLevel, configDir: this.config.cwd, engineProtocol: "json", enableTracing: this.tracingHelper.isEnabled() }, (n) => {
                var _a22;
                (_a22 = r.deref()) == null ? void 0 : _a22.logger(n);
              }, t));
            } catch (r) {
      ...
      start() {
        return __async(this, null, function* () {
          if (this.libraryInstantiationPromise || (this.libraryInstantiationPromise = this.instantiateLibrary()), yield this.libraryInstantiationPromise, yield this.libraryStoppingPromise, this.libraryStartingPromise) return Ce(`library already starting, this.libraryStarted: ${this.libraryStarted}`), this.libraryStartingPromise;
          ...
          let r = () => __async(this, null, function* () {
            ...
            try {
              ...
              yield (_a21 = this.engine) == null ? void 0 : _a21.connect(JSON.stringify(t)), this.libraryStarted = true, this.adapterPromise || (this.adapterPromise = (_c6 = (_b13 = this.config.adapter) == null ? void 0 : _b13.connect()) == null ? void 0 : _c6.then(Wn)), yield this.adapterPromise, Ce("library started");
            } catch (t) {
      ...
      stop() {
        return __async(this, null, function* () {
          var _a21;
          if (yield this.libraryInstantiationPromise, yield this.libraryStartingPromise, yield this.executingQueryPromise, this.libraryStoppingPromise) return Ce("library is already stopping"), this.libraryStoppingPromise;
          if (!this.libraryStarted) {
            yield (_a21 = yield this.adapterPromise) == null ? void 0 : _a21.dispose(), this.adapterPromise = void 0;
            return;
          }
          let r = () => __async(this, null, function* () {
            var _a22, _b13, _c6;
            yield new Promise((n) => setImmediate(n)), Ce("library stopping");
            let t = { traceparent: this.tracingHelper.getTraceParent() };
            yield (_a22 = this.engine) == null ? void 0 : _a22.disconnect(JSON.stringify(t)), ((_b13 = this.engine) == null ? void 0 : _b13.free) && this.engine.free(), this.engine = void 0, this.libraryStarted = false, this.libraryStoppingPromise = void 0, this.libraryInstantiationPromise = void 0, yield (_c6 = yield this.adapterPromise) == null ? void 0 : _c6.dispose(), this.adapterPromise = void 0, Ce("library stopped");
          });
      ...
      version() {
        var _a21, _b13, _c6;
        return this.versionInfo = (_a21 = this.library) == null ? void 0 : _a21.version(), (_c6 = (_b13 = this.versionInfo) == null ? void 0 : _b13.version) != null ? _c6 : "unknown";
      }
      debugPanic(r) {
        var _a21;
        return (_a21 = this.library) == null ? void 0 : _a21.debugPanic(r);
      }
      request(_0, _1) {
        return __async(this, arguments, function* (r, { traceparent: t, interactiveTransaction: n }) {
          ...
          try {
            yield this.start();
            let s = yield this.adapterPromise;
            this.executingQueryPromise = (_a21 = this.engine) == null ? void 0 : _a21.query(o, i, n == null ? void 0 : n.id), this.lastQuery = o;
            ...
            if (s.code === "GenericFailure" && ((_b13 = s.message) == null ? void 0 : _b13.startsWith("PANIC:"))) throw new le(So(this, s.message), this.config.clientVersion);
...
${a.backtrace}`, { clientVersion: this.config.clientVersion });
      ...
      requestBatch(_0, _1) {
        return __async(this, arguments, function* (r, { transaction: t, traceparent: n }) {
          ...
          let i = Mr(r, t);
          yield this.start();
          let o = yield this.adapterPromise;
          this.lastQuery = JSON.stringify(i), this.executingQueryPromise = (_a21 = this.engine) == null ? void 0 : _a21.query(this.lastQuery, JSON.stringify({ traceparent: n }), _l(t));
          ...
          if (Array.isArray(l)) return l.map((c) => {
            var _a22;
            return c.errors && c.errors.length > 0 ? (_a22 = this.loggerRustPanic) != null ? _a22 : this.buildQueryError(c.errors[0], o == null ? void 0 : o.errorRegistry) : { data: c };
          });
      ...
      getExternalAdapterError(r, t) {
        ...
        if (r.error_code === yf && t) {
          let n = (_a21 = r.meta) == null ? void 0 : _a21.id;
    ...
    function So(e, r) {
      var _a21;
      return Pl({ binaryTarget: e.binaryTarget, title: r, version: e.config.clientVersion, engineVersion: (_a21 = e.versionInfo) == null ? void 0 : _a21.commit, database: e.config.activeProvider, query: e.lastQuery });
    }
...
`);
    ...
    function ql({ copyEngine: e = true }, r) {
      let t;
      try {
        t = jr({ inlineDatasources: r.inlineDatasources, overrideDatasources: r.overrideDatasources, env: __spreadValues(__spreadValues({}, r.env), process.env), clientVersion: r.clientVersion });
      } catch (e2) {
      }
    ...
    function Hn({ generator: e }) {
      var _a21;
      return (_a21 = e == null ? void 0 : e.previewFeatures) != null ? _a21 : [];
    }
    var jl = (e) => ({ command: e });
...
`);
    ...
    var Io = class {
      ...
      getGlobalTracingHelper() {
        ...
        return (_b13 = (_a21 = r == null ? void 0 : r.helper) != null ? _a21 : t == null ? void 0 : t.helper) != null ? _b13 : Rf;
      }
    };
    function Yl() {
      return new Io();
    ...
    function Zn(e) {
      ...
      for (let n = 0; n < e.rows.length; n++) {
        let i = e.rows[n], o = __spreadValues({}, t);
    ...
    var Xn = class {
      constructor(r, t) {
        ...
        __publicField(this, "logEmitter");
        this.logEmitter = t, this.client = r, this.dataloader = new zn({ batchLoader: ol((_0) => __async(this, [_0], function* ({ requests: n, customDataProxyFetch: i }) {
          ...
          return (yield this.client._engine.requestBatch(a, { traceparent: l, transaction: kf(o), containsWrite: u, customDataProxyFetch: i })).map((p, d) => {
          ...
          var _a21;
          let i = ((_a21 = n.transaction) == null ? void 0 : _a21.kind) === "itx" ? ru(n.transaction) : void 0, o = yield this.client._engine.request(n.protocolQuery, { traceparent: this.client._tracingHelper.getTraceParent(), interactiveTransaction: i, isWrite: Do(n.protocolQuery.action), customDataProxyFetch: n.customDataProxyFetch });
          return this.mapQueryEngineResult(n, o);
        }), batchBy: (n) => {
          var _a21;
          return ((_a21 = n.transaction) == null ? void 0 : _a21.id) ? `transaction-${n.transaction.id}` : Xl(n.protocolQuery);
        }, batchOrder(n, i) {
          var _a21, _b13;
          return ((_a21 = n.transaction) == null ? void 0 : _a21.kind) === "batch" && ((_b13 = i.transaction) == null ? void 0 : _b13.kind) === "batch" ? n.transaction.index - i.transaction.index : 0;
        } });
      }
      request(r) {
        return __async(this, null, function* () {
      ...
      handleRequestError({ error: r, clientMethod: t, callsite: n, transaction: i, args: o, modelName: s, globalOmit: a }) {
        ...
        if (n && (l = wn({ callsite: n, originalMethod: t, isPanic: r.isPanic, showColors: this.client._errorFormat === "pretty", message: l })), l = this.sanitizeMessage(l), r.code) {
          let u = s ? __spreadValues({ modelName: s }, r.meta) : r.meta;
...
Expected string or undefined.`);
    ...
    function Lf(e, r) {
      var _a21;
      return (_a21 = au(r.models, e)) != null ? _a21 : au(r.types, e);
    }
    function au(e, r) {
    ...
    function Ff(e, r) {
      ...
      for (let o of r) switch (o.kind) {
        case "UnknownModel":
          (_a21 = t.arguments.getField(o.modelKey)) == null ? void 0 : _a21.markAsError(), t.addErrorMessage(() => `Unknown model name: ${o.modelKey}.`);
          break;
        case "UnknownField":
          (_b13 = t.arguments.getDeepField([o.modelKey, o.fieldName])) == null ? void 0 : _b13.markAsError(), t.addErrorMessage(() => `Model "${o.modelKey}" does not have a field named "${o.fieldName}".`);
          break;
        case "RelationInOmit":
    ...
    function hu(e) {
      class r {
        constructor(n) {
          ...
          __publicField(this, "_middlewares", new Kn());
          ...
          var _a21, _b13, _c6, _d5, _e6, _f2, _g, _h, _i2, _j, _k, _l2, _m2;
          e = (_c6 = (_b13 = (_a21 = n == null ? void 0 : n.__internal) == null ? void 0 : _a21.configOverride) == null ? void 0 : _b13.call(_a21, e)) != null ? _c6 : e, cl(e), n && uu(n, e);
          let i = new fu.EventEmitter().on("error", () => {
          });
          this._extensions = Nr.empty(), this._previewFeatures = Hn(e), this._clientVersion = (_d5 = e.clientVersion) != null ? _d5 : nu, this._activeProvider = e.activeProvider, this._globalOmit = n == null ? void 0 : n.omit, this._tracingHelper = Yl();
          ...
          let a = !s && o && ot(o, { conflictCheck: "none" }) || ((_e6 = e.injectableEdgeEnv) == null ? void 0 : _e6.call(e));
          try {
            ...
            let d = u.engine || {};
            if (l.errorFormat ? this._errorFormat = l.errorFormat : process.env.NODE_ENV === "production" ? this._errorFormat = "minimal" : process.env.NO_COLOR ? this._errorFormat = "colorless" : this._errorFormat = "colorless", this._runtimeDataModel = e.runtimeDataModel, this._engineConfig = { cwd: p, dirname: e.dirname, enableDebugLogs: c, allowTriggerPanic: d.allowTriggerPanic, prismaPath: (_g = d.binaryPath) != null ? _g : void 0, engineEndpoint: d.endpoint, generator: e.generator, showColors: this._errorFormat === "pretty", logLevel: l.log && Zl(l.log), logQueries: l.log && !!(typeof l.log == "string" ? l.log === "query" : l.log.find((f) => typeof f == "string" ? f === "query" : f.level === "query")), env: (_h = a == null ? void 0 : a.parsed) != null ? _h : {}, flags: [], engineWasm: e.engineWasm, compilerWasm: e.compilerWasm, clientVersion: e.clientVersion, engineVersion: e.engineVersion, previewFeatures: this._previewFeatures, activeProvider: e.activeProvider, inlineSchema: e.inlineSchema, overrideDatasources: pl(l, e.datasourceNames), inlineDatasources: e.inlineDatasources, inlineSchemaHash: e.inlineSchemaHash, tracingHelper: this._tracingHelper, transactionOptions: { maxWait: (_j = (_i2 = l.transactionOptions) == null ? void 0 : _i2.maxWait) != null ? _j : 2e3, timeout: (_l2 = (_k = l.transactionOptions) == null ? void 0 : _k.timeout) != null ? _l2 : 5e3, isolationLevel: (_m2 = l.transactionOptions) == null ? void 0 : _m2.isolationLevel }, logEmitter: i, isBundled: e.isBundled, adapter: s }, this._accelerateEngineConfig = __spreadProps(__spreadValues({}, this._engineConfig), { accelerateUtils: { resolveDatasourceUrl: jr, getBatchRequestPayload: Mr, prismaGraphQLToJSError: $r, PrismaClientUnknownRequestError: j, PrismaClientInitializationError: T, PrismaClientKnownRequestError: z, debug: N("prisma:client:accelerateEngine"), engineVersion: du.version, clientVersion: e.clientVersion } }), rr("clientVersion", e.clientVersion), this._engine = ql(e, this._engineConfig), this._requestHandler = new Xn(this, i), l.log) for (let f of l.log) {
              let h = typeof f == "string" ? f : f.emit === "stdout" ? f.level : null;
              h && this.$on(h, (g) => {
                var _a22;
                tt.log(`${(_a22 = tt.tags[h]) != null ? _a22 : ""}`, g.message || g.query);
              });
            }
          } catch (l) {
        ...
        _transactionWithArray({ promises: n, options: i }) {
          let o = qf.nextId(), s = zl(n.length), a = n.map((l, u) => {
            ...
            let c = (_a21 = i == null ? void 0 : i.isolationLevel) != null ? _a21 : this._engineConfig.transactionOptions.isolationLevel, p = { kind: "batch", id: o, index: u, isolationLevel: c, lock: s };
            return (_c6 = (_b13 = l.requestTransaction) == null ? void 0 : _b13.call(l, p)) != null ? _c6 : l;
          });
          return cu(a);
        }
        _transactionWithCallback(_0) {
          return __async(this, arguments, function* ({ callback: n, options: i }) {
            var _a21, _b13, _c6;
            let o = { traceparent: this._tracingHelper.getTraceParent() }, s = { maxWait: (_a21 = i == null ? void 0 : i.maxWait) != null ? _a21 : this._engineConfig.transactionOptions.maxWait, timeout: (_b13 = i == null ? void 0 : i.timeout) != null ? _b13 : this._engineConfig.transactionOptions.timeout, isolationLevel: (_c6 = i == null ? void 0 : i.isolationLevel) != null ? _c6 : this._engineConfig.transactionOptions.isolationLevel }, a = yield this._engine.transaction("start", o, s), l;
            try {
        ...
        $transaction(n, i) {
          var _a21;
          let o;
          typeof n == "function" ? ((_a21 = this._engineConfig.adapter) == null ? void 0 : _a21.adapterName) === "@prisma/adapter-d1" ? o = () => {
...
`)), (c == null ? void 0 : c.kind) === "batch" && (yield c.lock), this._requestHandler.request({ protocolQuery: g, modelName: l, action: a, clientMethod: i, dataPath: o, callsite: s, args: n, extensions: this._extensions, transaction: c, unpacker: p, otelParentCtx: d, otelChildCtx: this._tracingHelper.getActiveContext(), globalOmit: this._globalOmit, customDataProxyFetch: f });
        ...
        _hasPreviewFlag(n) {
          var _a21;
          return !!((_a21 = this._engineConfig.previewFeatures) == null ? void 0 : _a21.includes(n));
        }
        $applyPendingMigrations() {
...
var require_prisma = __commonJS({
  "src/generated/prisma/index.js"(exports2) {
    ...
    exports2.Prisma.AppScalarFieldEnum = {
      id: "id",
      name: "name",
      secretKey: "secretKey",
      baseUrl: "baseUrl",
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/home/alok/Desktop/combine/Nirva/backend/src/generated/prisma",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/home/alok/Desktop/combine/Nirva/backend/prisma/schema.prisma",
        "isCustomOutput": true
      },
      "relativeEnvPaths": {
        "rootEnvPath": null
      ...
      "inlineSchema": '// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = "prisma-client-js"\n  output   = "../src/generated/prisma"\n}\n\ndatasource db {\n  provider = "postgresql"\n  url      = env("DATABASE_URL")\n}\n\nmodel User {\n  id        String   @id @default(uuid())\n  name      String\n  password  String? //optional if you are using oauth\n  email     String?  @unique\n  oauthId   String?  @unique // nullable for non-OAuth users\n  provider  String\n  createdAt DateTime @default(now())\n  // Apps this user has created\n  App       App[]    @relation("AppCreator")\n\n  // Nullable relation: which app this user is using (consumer)\n  app_id String?\n  app    App?    @relation("AppConsumer", fields: [app_id], references: [id])\n}\n\nmodel App {\n  id        String   @id @default(uuid())\n  name      String\n  secretKey String   @unique\n  baseUrl   String\n  redirect  String\n  userId    String // creator/owner\n  createdAt DateTime @default(now())\n\n  // Creator/owner relation\n  user User @relation("AppCreator", fields: [userId], references: [id])\n\n  // Optional back-relation for consumers\n  consumers User[] @relation("AppConsumer")\n}\n',
      "inlineSchemaHash": "267f80d4636f5586088226e0106a80f5dedc7aa2b839d717e4544c9c0f06cf33",
      "copyEngine": true
    };
    var fs = require("fs");
    ...
    config.runtimeDataModel = JSON.parse('{"models":{"User":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"name","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"password","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"email","kind":"scalar","isList":false,"isRequired":false,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"oauthId","kind":"scalar","isList":false,"isRequired":false,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"provider","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"App","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"App","nativeType":null,"relationName":"AppCreator","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"app_id","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"app","kind":"object","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"App","nativeType":null,"relationName":"AppConsumer","relationFromFields":["app_id"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"App":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"name","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"secretKey","kind":"scalar","isList":false,"isRequired":true,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"baseUrl","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"redirect","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"userId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"user","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"AppCreator","relationFromFields":["userId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"consumers","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"AppConsumer","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false}},"enums":{},"types":{}}');
...
// src/config/db.ts
var import_prisma, db;
var init_db = __esm({
  "src/config/db.ts"() {
    "use strict";
    import_prisma = __toESM(require_prisma());
    db = globalThis.prisma || new import_prisma.PrismaClient({
      log: ["query"]
    });
...
var import_bcryptjs, findOrCreateUser, register, login;
var init_userService = __esm({
  "src/services/userService.ts"() {
    ...
    init_tokenService();
    findOrCreateUser = (profile, provider, key) => __async(null, null, function* () {
      var _a, _b;
      const email = (_b = (_a = profile.emails) == null ? void 0 : _a[0]) == null ? void 0 : _b.value;
    ...
    register = (email, password, name, AppUser) => __async(null, null, function* () {
    ...
    login = (email, password) => __async(null, null, function* () {
      const user = yield db.user.findUnique({ where: { email } });
...
var require_google = __commonJS({
  "src/strategies/google.ts"(exports2) {
    "use strict";
    ...
    import_passport3.default.use(
      new import_passport_google_oauth20.Strategy(
        ...
        (req, accessToken, refreshToken, profile, done) => __async(null, null, function* () {
          try {
            ...
            const user = yield findOrCreateUser(profile, "google", key);
            done(null, user);
          } catch (err) {
...
var require_github = __commonJS({
  "src/strategies/github.ts"(exports2) {
    "use strict";
    ...
    import_passport3.default.use(
      new import_passport_github2.Strategy(
        ...
        (profile, done) => __async(null, null, function* () {
          var _a, _b;
          try {
            const email = ((_b = (_a = profile.emails) == null ? void 0 : _a[0]) == null ? void 0 : _b.value) || `${profile.username}@github.com`;
            let user = yield db.user.findFirst({
              where: { email }
            });
            if (!user) {
              user = yield db.user.create({
            ...
            return done(null, __spreadProps(__spreadValues({}, user), { token }));
          } catch (err) {
            return done(err);
          }
        })
...
// src/services/findAppUserService.ts
init_db();
var findAppUser = (secretKey) => __async(null, null, function* () {
  const app2 = yield db.app.findUniqueOrThrow({
    where: {
      secretKey
    }
  });
...
// src/controllers/auth.controller.ts
var register2 = (req, res) => __async(null, null, function* () {
  try {
    ...
    const AppUser = yield findAppUser(key);
    const user = yield register(email, password, name, AppUser);
    res.status(201).json({
      success: true,
...
var login2 = (req, res) => __async(null, null, function* () {
  try {
    ...
    res.status(200).json({ token, message: "Successfully logged in", success: true });
  } catch (error) {
    console.error(error);
...
var findCallbackUriWithSecretKey = (secretkey) => __async(null, null, function* () {
  const appRecord = yield db.app.findFirst({
    where: {
...
router.get(
  "/google/callback",
  import_passport.default.authenticate("google", { session: false, failureRedirect: "/" }),
  (req, res) => __async(null, null, function* () {
    const token = generateToken(req.user);
    const key = req.query.state ? decodeURIComponent(req.query.state.toString()) : null;
    if (!key) {
    ...
    const redirectURI = yield findCallbackUriWithSecretKey(key);
...
router.get("/github", (req, res, next) => {
  ...
  import_passport.default.authenticate("github", authOptions)(req, res, next);
});
router.get(
  "/github/callback",
  import_passport.default.authenticate("github", {
    session: false,
    failureRedirect: "/"
    // redirect on error
  }),
...
init_db();
var CreateApp = (req, res) => __async(null, null, function* () {
  try {
    ...
    const app2 = yield db.app.create({
      data: {
        name,
        baseUrl,
    ...
    return res.status(201).json({ message: "App created successfully", app: app2 });
  } catch (error) {
    console.error("CreateApp error:", error);
    return res.status(500).json({ message: "Internal server error" });
  }
});
var MyApps = (req, res) => __async(null, null, function* () {
  try {
    const user = req.user;
    if (!(user == null ? void 0 : user.id)) {
      return res.status(401).json({ message: "Unauthorized" });
    }
    const apps = yield db.app.findMany({
      where: {
        userId: user.id
      }
    });
    const today = (/* @__PURE__ */ new Date()).toISOString();
    const formattedApps = apps.map((app2) => __spreadProps(__spreadValues({}, app2), {
      status: 1,
      last_used: today
    }));
    return res.json({
...
router2.post("/create", authGuard, CreateApp);
router2.get("/getMyApps", authGuard, MyApps);
...
// src/services/dynamicCors.ts
var import_cors = __toESM(require("cors"));
init_db();
var dynamicCors = (0, import_cors.default)({
  origin: (origin, callback) => __async(null, null, function* () {
    if (!origin) return callback(null, true);
    try {
      const app2 = yield db.app.findFirst({ where: { baseUrl: origin } });
      if (app2) return callback(null, true);
    } catch (e) {
...
app.use("/apps", app_routes_default);
app.get("/", (req, res) => {
