  ...
  "src/generated/prisma/index.js"(exports2) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/home/alok/Desktop/auth-service/src/generated/prisma",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/home/alok/Desktop/auth-service/prisma/schema.prisma",
        "isCustomOutput": true
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
      ...
      "inlineSchemaHash": "c88cd35a07433a9280bbd8f4a8139b54a9d2bd5adc4e4cb1ae82130c1d38f501",
      "copyEngine": true
    };
    var fs = require("fs");
...
var init_userService = __esm({
  "src/services/userService.ts"() {
    ...
    init_tokenService();
    findOrCreateUser = (profile, provider) => __async(null, null, function* () {
      var _a, _b;
    ...
    register = (email, password, name) => __async(null, null, function* () {
    ...
    import_passport3.default.use(
      new import_passport_google_oauth20.Strategy(
        ...
        (profile, done) => __async(null, null, function* () {
          const user = yield findOrCreateUser(profile, "google");
          console.log(user);
          done(null, user);
        })
      )
...
var register2 = (req, res) => __async(null, null, function* () {
  ...
  const user = yield register(email, password, name);
...
router.get(
  "/github",
  import_passport.default.authenticate("github", { scope: ["user:email"] })
);
router.get(
  "/github/callback",
...
app.use((0, import_cors.default)({
  ...
  credentials: true
  // if you are using cookies/auth headers
}));
